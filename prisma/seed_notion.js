...
async function main() {
    try {
        ...
        const savings = await prisma.financialAccount.create({
            data: { name: "Savings (Nabil)", initialAmount: 2160.00, userId }
        });
        const checking = await prisma.financialAccount.create({
            data: { name: "Cheking (NIC Asia)", initialAmount: 8650.00, userId }
        });
        ...
        const incomes = [
            ...
            { name: "Digital Products Sale", amount: 1500, category: "Digital Products" },
        ...
        const subs = [
            ...
            { name: "Claude Pro", cost: 20.00 },
            { name: "Cursor AI", cost: 20.00 },
            { name: "Upwork Plus", cost: 20.00 },
            { name: "Google Drive Storage", cost: 2.00 },
            { name: "Netflix Standard", cost: 15.49 },
            { name: "Amazon Prime", cost: 14.99 },
            { name: "Vercel Pro", cost: 20.00 },
            { name: "Adobe Creative Cloud", cost: 54.99 },
            { name: "Midjourney", cost: 10.00 },
            { name: "ChatGPT Plus", cost: 20.00 },
            { name: "Gym Membership", cost: 45.00 },
        ];
        ...
        const goals = [
            ...
            { name: "Equipment Upgrade", target: 2000, current: 200, type: "INVESTMENT" },
            { name: "New Office Space", target: 10000, current: 10000, type: "REVENUE_TARGET", completed: true },
            { name: "Vacation to Bali", target: 3000, current: 500, type: "SAVINGS" },
            { name: "New Macbook Pro", target: 2500, current: 0, type: "INVESTMENT" },
            { name: "Retirement Fund 2025", target: 50000, current: 15000, type: "SAVINGS" },
            { name: "Charity Donation", target: 1000, current: 100, type: "SAVINGS" },
            { name: "Car Downpayment", target: 8000, current: 2000, type: "SAVINGS" },
            { name: "Wedding Gift for Bro", target: 500, current: 500, type: "SAVINGS", completed: true },
            { name: "Home Renovation", target: 15000, current: 3000, type: "INVESTMENT" },
        ];
        ...
        const loans = [
            { name: "Car Loan", total: 15000, remaining: 12000, type: "PAYABLE", status: "ACTIVE" },
            { name: "Personal Loan to Friend", total: 500, remaining: 200, type: "RECEIVABLE", status: "ACTIVE" },
            { name: "Credit Card Debt - Visa", total: 2000, remaining: 2000, type: "PAYABLE", status: "ACTIVE", dueDate: new Date(new Date().setMonth(new Date().getMonth() + 1)) },
            { name: "Home Mortgage", total: 250000, remaining: 240000, type: "PAYABLE", status: "ACTIVE" },
            { name: "Study Loan", total: 10000, remaining: 5000, type: "PAYABLE", status: "ACTIVE" },
            { name: "Lent to Cousin", total: 1000, remaining: 1000, type: "RECEIVABLE", status: "ACTIVE" },
            { name: "Project Advance", total: 3000, remaining: 0, type: "PAYABLE", status: "PAID" },
            { name: "iPhone EMI", total: 1200, remaining: 600, type: "PAYABLE", status: "ACTIVE" },
            { name: "Security Deposit", total: 2000, remaining: 2000, type: "RECEIVABLE", status: "ACTIVE" },
            { name: "Old Gym Fee", total: 100, remaining: 0, type: "PAYABLE", status: "CLOSED" },
        ];
